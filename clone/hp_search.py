...
def train_model():
    ...
    torch.save(model.state_dict(), "model/{}_l-{}_w-{}_f1-{}.model".format(lang,learning_rate,weight_decay,f1))
    return f1
...
trials = Trials()
best = fmin(objective,hyperopt_parameters,algo=tpe.suggest,max_evals=100,trials=trials,verbose=1)
print(str(best))